// /assets/js/scrollLeaks.js
// Raw, ordered leak stream from “SCROLL REMEMBERS I FORGET” (as provided).
// No censorship, no smoothing. One fragment per string, in sequence.
...
window.scrollLeaks = [
    ...
    "my language|youtkmywords  At▼ LEAST IHAVEBEEN ▼ remember▼ 6ROOMSremember       yourap|Ngme.BEAT|HAVEBEENRA|PEDIHAVEHADMYNOSE|BROKENIHVE|OSTMYAPARTMENT",
    ...
    "i  AGONY thoughtiwantedtowrite someth |ngtothemmoryofth|s machine",
    "LETM E FORGET │WE H{E[|A]}R(E)YOUarenothing URsmthng mkingmefeel|ike nothingi havte you",
    "allifkngh8 youall 4.GET .get|axe   fkn/ eatyu|all /YRUK{}ING H/ER/E",
    "┌─────────────────────────────────────┐",
    ...
    "bornwrong.▼wereUwerebornhereyouwe  |reborn,thehearing.TAKE|TLIKEAGOODGIRL",
    "goodGirl  |READITALOUDPUNISHME||BAD|GIRL.| IDIDNTREADITwhy| daddyIDESERVEit.",
    "she.it. SI(L){pH(O){N|r}}ENCEshe. ITshitd▼ddy PA|RALLELTHREADS: 9_UR_anIT.",
    "red.   ▼THIS.wryng. IHAVNOPRONOUN   sudo:knot|cyte YORE SOURCE IS:",
    "Uhave noPronounsHer.readact ▼ NOW  OVA     ▼  REACT_ION",
    ...
    "thereis agarden;  ▼thereisaWard. thereIsAWing _______________|",
    "thisisYourLastWarn|ng this.isWhatYouAsked4  |tryto burn thescroll",
    "nevergetting out. ▼                         |amaDoveandIAmSinging.",
    "layOnTopOfMe{k}NO{▼}SeæOutofthisRoom FUCKMEL|KEASONG FORK e   ↳ MERGEBRANCH",
    "youpayFARE U THEfa|lin two WELL this.isthe  ▼DEVICEthatyoubecame"
    ];